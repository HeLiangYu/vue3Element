<template>
  ...
  <div class="row">
    <Collapse v-model="openedValue2" @change="changeHandle" accordion>
      <CollapseItem name="a" title="home">
        Lorem ipsum dolor sit amet consectetur, adipisicing elit. Odit, temporibus.
      </CollapseItem>
      <CollapseItem name="b" title="about">
  ...
  <div class="row">
    <Collapse v-model="openedValue3" accordion>
      ...
      <CollapseItem name="Controllability" title="Controllability">
        <template #title>
          <div class="titleContainer">
            <Icon icon="star" />
